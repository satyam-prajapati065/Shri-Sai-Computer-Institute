      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p>
              Your trusted regional institute providing career-focused computer applications,
              financial accounting, typing, and digital design education with 100% practical lab
              training.
            </p>
        ...
        <div className="footer-bottom">
          ...
          <div>100% Practical Computer Lab • Zero Admission Fee • Zero Certificate Fee</div>
        </div>
      </div>
    </footer>
  );
