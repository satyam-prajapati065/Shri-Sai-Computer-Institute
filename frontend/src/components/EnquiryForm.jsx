  ...
  const handleSubmit = (e) => {
    ...
    if (backendApiUrl) {
      try {
        ...
        }).catch((err) => console.log('Backend notification note:', err));
      } catch (err) {
        console.log('Backend API note:', err);
      }
    }
