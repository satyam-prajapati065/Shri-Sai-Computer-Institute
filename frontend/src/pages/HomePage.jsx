        ...
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title">
              Popular Job-Ready Courses & Transparent Fees
            </h2>
            <p className="section-subtitle">
              Choose from our most enrolled computer diplomas, accounting
              courses with live GST/ITR, and typing programs.
            </p>
          </div>
          ...
          <div className="home-courses-footer-cta">
            <p>
              Looking for more specialized diplomas, CorelDRAW, or basic
              computer courses?
            </p>
            <button
          ...
          <div className="home-preview-grid">
            <div className="preview-card-left">
              ...
              <p className="preview-text">
                Established with a vision to make high quality, practical
                computer education affordable and accessible to every student in
                Ambedkar Nagar and surrounding regions.
              </p>
              <div className="preview-checklist">
                <div className="check-item">
                  <CheckCircle2 size={16} color="#15803d" />{" "}
                  <span>Experienced faculty: Annu Gupta & Sadhna Jaiswal</span>
                </div>
                <div className="check-item">
                  <CheckCircle2 size={16} color="#15803d" />{" "}
                  <span>
                    Separate flexible batches (Morning, Afternoon, Evening)
                  </span>
                </div>
                <div className="check-item">
                  <CheckCircle2 size={16} color="#15803d" />{" "}
                  <span>GST Return and ITR filing live practical training</span>
                </div>
                <div className="check-item">
                  <CheckCircle2 size={16} color="#15803d" />{" "}
                  <span>
                    English & Hindi touch typing speed lab (Kruti Dev / Mangal)
                  </span>
                </div>
              </div>
              <div className="preview-card-left-buttons">
                <button
              ...
              <div className="faculty-spotlight-box">
                ...
                <div className="batch-status-box">
                  ...
                  <div>
                    ...
                    <p>
                      Limited seats per batch to ensure individual PC
                      allocation.
                    </p>
                  </div>
                </div>
