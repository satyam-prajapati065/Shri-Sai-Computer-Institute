  ...
  const classroomImages = [
    {
      ...
      caption: 'Students practicing real software workflows with individual system allocation.',
    },
    {
      url: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=800&q=80',
      title: 'Supportive Mentorship & Guidance',
      caption: 'Dedicated faculty Annu Gupta & Sadhna Jaiswal providing step-by-step guidance.',
    },
    {
      url: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=800&q=80',
      title: 'Accounting & Tally Prime Lab',
      caption: 'Hands-on practice on ledger creation, voucher entries, GST billing, and taxation.',
    },
    {
      ...
      caption: 'Daily Hindi & English typing drills using standardized examination typing software.',
    },
  ];
      ...
      <section className="training-pillars-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <h2 className="section-title">Our 4-Step Practical Learning Model</h2>
            <p className="section-subtitle">
              How we transform beginners into confident, skilled, and certified computer professionals.
            </p>
          </div>
            ...
            {instituteData.trainingPillars.map((pillar, idx) => (
              <div key={idx} className="pillar-bento-card">
                ...
                <div className="pillar-highlight">
                  <CheckCircle2 size={14} color="#15803d" /> Verified Lab Workflow
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="specialized-tracks-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <p className="section-subtitle">
              Explore how we teach accounting, typing, graphic design, and office automation in our labs.
            </p>
          </div>
            ...
            {activeTab === 'accounting' && (
              <div className="track-content-grid">
                <div className="track-text">
                  ...
                  <p>
                    Accounting is more than just memorizing debits and credits. At Shri Sai, students practice real business voucher entries, bank reconciliations, inventory management, E-Way bills, and live portal filing for <strong>GST Returns (GSTR-1, GSTR-3B)</strong> and <strong>Income Tax Returns (ITR)</strong>.
                  </p>
                  <ul className="track-bullets">
                    <li>✓ Creating ledgers, purchase/sales vouchers, and GST invoices in Tally Prime.</li>
                    <li>✓ Live portal GST Return filing simulation (GSTR-1 sales, GSTR-3B summary).</li>
                    <li>✓ Income Tax Return (ITR-1 / ITR-2) computation and e-filing overview.</li>
                    <li>✓ Generating real Profit & Loss accounts, balance sheets, and audit reports.</li>
                  </ul>
            ...
            {activeTab === 'typing' && (
              <div className="track-content-grid">
                <div className="track-text">
                  ...
                  <p>
                    Typing speed is critical for government examinations (High Court Clerk, ARO, SSC CHSL, Railway, UP Police) and private data entry roles. We provide structured daily drills on both English and Hindi keyboard layouts (Kruti Dev 010 and Mangal Remington/Inscript).
                  </p>
                  <ul className="track-bullets">
                    <li>✓ Correct 10-finger placement drills for blind touch typing.</li>
                    <li>✓ Real-time speed (WPM) and accuracy (%) tracking software.</li>
                    <li>✓ Hindi font options: Kruti Dev 010 & Mangal (Inscript / Remington).</li>
                    <li>✓ Exam-style typing test simulations with backspace controls.</li>
                  </ul>
                  <div className="track-fee-pill">
            ...
            {activeTab === 'design' && (
              <div className="track-content-grid">
                <div className="track-text">
                  ...
                  <p>
                    Master commercial image manipulation, flex banner design, visiting cards, social media creatives, and print-ready files using industry-standard Adobe Photoshop and CorelDRAW.
                  </p>
                  <ul className="track-bullets">
                    <li>✓ Layer masks, pen tool selection, background removal & color correction.</li>
                    <li>✓ Passport size photo printing and photo studio editing tricks.</li>
                    <li>✓ Commercial flex banner, pamphlet, and invitation card designing.</li>
                    <li>✓ Vector illustrations, branding logos, and CMYK print setup.</li>
                  </ul>
                  <div className="track-fee-pill">
                    Photoshop: <strong>₹4,000</strong> | CorelDRAW: <strong>₹4,000</strong>
                  </div>
                </div>
                <div className="track-media">
                  <img 
            ...
            {activeTab === 'office' && (
              <div className="track-content-grid">
                <div className="track-text">
                  ...
                  <p>
                    Become indispensable in any modern office by mastering advanced spreadsheet formulas, lookup functions, pivot tables, official letter typing, mail merge, and impactful slide decks.
                  </p>
                  <ul className="track-bullets">
                    <li>✓ Advanced Excel formulas: IF, VLOOKUP, XLOOKUP, INDEX/MATCH, COUNTIF.</li>
                    <li>✓ Pivot tables, dynamic charts, and financial summary dashboards.</li>
                    <li>✓ MS Word table formatting, headers/footers, and Mail Merge for bulk letters.</li>
                    <li>✓ Professional PowerPoint presentation animations and slide transitions.</li>
                  </ul>
                  <div className="track-fee-pill">
      ...
      <section className="lab-infra-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <p className="section-subtitle">Comfortable, high-tech, and disciplined learning environment.</p>
          </div>

          <div className="infra-grid">
            <div className="infra-card">
              <div className="infra-icon"><Laptop size={24} color="#1e40af" /></div>
              <h4>Individual High-Speed Systems</h4>
              <p>Every student receives their own dedicated PC during batch hours with no sharing.</p>
            </div>

            <div className="infra-card">
              <div className="infra-icon"><Zap size={24} color="#f59e0b" /></div>
              <h4>100% Power Backup</h4>
              <p>Inverter and generator support ensure uninterrupted lab sessions during power outages.</p>
            </div>

            <div className="infra-card">
              <div className="infra-icon"><Keyboard size={24} color="#15803d" /></div>
              <h4>Full Typing Test Suite</h4>
              <p>Pre-installed software for Kruti Dev, Mangal, and English touch-typing speed drills.</p>
            </div>

            <div className="infra-card">
              <div className="infra-icon"><Clock size={24} color="#b91c1c" /></div>
              <h4>Flexible Batch Timings</h4>
              <p>Morning, afternoon, and evening batches from 7:00 AM to 7:00 PM to fit your routine.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="classroom-gallery-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <p className="section-subtitle">Glimpses of daily practical learning and dedicated mentorship.</p>
          </div>
      ...
      <section className="training-bottom-cta">
        <div className="container">
          <div className="training-cta-inner">
            ...
            <p>Book your 2-day free demo class and sit in on an actual live lab session with our instructors.</p>
