      ...
      <section className="why-us-grid-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <h2 className="section-title">Everything You Need for Digital & Career Success</h2>
            <p className="section-subtitle">
              Carefully designed learning advantages that prioritize your practical skills, budget, and confidence.
            </p>
          </div>
        ...
        <div className="container">
          <div className="ccc-spotlight-card">
            <div className="ccc-left-content">
              <span className="ccc-mini-tag">Special Govt. Accreditation Assistance</span>
              <h2>Course on Computer Concepts (CCC) Certificate Available</h2>
              <p>
                Preparing for Government Exams (UPSSSC, Lekhpal, VDO, Police, Railway, High Court)? The NIELIT CCC certificate is a mandatory qualification. At Shri Sai Computer Institute, we provide complete online exam preparation, previous year question banks, mock tests, and certification guidance.
              </p>
              <div className="ccc-highlights-row">
                <span className="ccc-badge"><Award size={15} /> NIELIT CCC Syllabus</span>
                <span className="ccc-badge"><Check size={15} /> Daily Computer Lab Practice</span>
                <span className="ccc-badge"><Zap size={15} /> Transparent Fee: ₹2,500</span>
              </div>
            </div>
      ...
      <section className="comparison-table-section">
        <div className="container">
          <div className="section-header text-center">
            ...
            <h2 className="section-title">How Shri Sai Compares to Other Centers</h2>
            <p className="section-subtitle">See why students and parents consistently choose Shri Sai Computer Institute.</p>
          </div>
            ...
            <table className="comparison-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="highlight-col"><span className="tag-green">₹0 (ZERO Admission Fee)</span></td>
                  <td className="muted-col"><span className="tag-red">₹500 - ₹1,500 Extra</span></td>
                </tr>
                <tr>
                  <td><strong>Certificate Issuance Charge</strong></td>
                  <td className="highlight-col"><span className="tag-green">₹0 (Included with course)</span></td>
                  <td className="muted-col"><span className="tag-red">₹500 - ₹1,000 Surprise Fee</span></td>
                </tr>
                <tr>
                  <td><strong>Free Trial / Demo Class</strong></td>
                  <td className="highlight-col"><span className="tag-green">2 Days Full Free Demo</span></td>
                  <td className="muted-col"><span className="tag-red">Rarely Provided</span></td>
                </tr>
                <tr>
                  <td><strong>Computer Allocation in Lab</strong></td>
                  <td className="highlight-col"><strong>1 Student = 1 Dedicated PC</strong></td>
                  <td className="muted-col">2-3 Students sharing 1 monitor</td>
                </tr>
                <tr>
                  <td><strong>Accounting with Live GST Return & ITR</strong></td>
                  <td className="highlight-col"><span className="tag-green">Live Portal Tax Filing Included</span></td>
                  <td className="muted-col">Basic textbook journal entries only</td>
                </tr>
                <tr>
                  <td><strong>Typing Facility (Hindi + English)</strong></td>
                  <td className="highlight-col">Daily speed drills (Kruti Dev & Mangal)</td>
        ...
        <div className="container">
          <div className="matcher-box">
            <div className="matcher-header">
              ...
              <p>Select your primary goal to see the most beneficial course for your career:</p>
            </div>
            ...
            <div className="recommendation-result-box">
              <div className="rec-left">
                ...
                <div className="rec-fee-tag">Course Fee: <strong>{recommendation.fee}</strong></div>
              </div>
      ...
      <section className="why-bottom-cta">
        <div className="container">
          <div className="why-cta-inner">
            ...
            <p>Visit our nearest campus in Ambedkar Nagar, meet our faculty, and test our lab systems.</p>
            <div className="cta-actions">
              <button className="btn btn-red btn-lg" onClick={() => onNavigate('contact')}>
                Contact Us for Admissions
              </button>
              <a href={`tel:${instituteData.phone}`} className="btn btn-white btn-lg">
