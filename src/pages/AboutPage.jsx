  ...
  return (
    <div className="page-container page-about">
      ...
      <PageHeader
        ...
        subtitle="Empowering students, job aspirants, and working professionals across Ambedkar Nagarwith 100% practical computer applications, accounting, graphic designing, and digital literacy."
        trustPoints={[
